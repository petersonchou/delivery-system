...
<html class="no-js">
    ...
    <body>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div style="text-align:center">
                                ...
                                状态：<span class="modal-title-status" style="color:#59B259;font-weight:bold;"></span>
                            </div>
                        </div>
        ...
        <script src="{$Think.const.ADMIN_JS_URL}list-passed.js"></script>
        ...
        <script>
            $(function(){
                ...
                //点击拒绝按钮
                $(".tablebody").on("click",".btn_refuse",function(){
                    var rowid = parseInt($(this).parent().parent().children('.rowid').text());
                    layer.msg('确定要拒绝他？', {
                      time: 0 //不自动关闭
                      ,btn: ['必须的', '不']

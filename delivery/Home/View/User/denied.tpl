...
<html class="no-js">
    ...
    <body>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" style="text-align:center;margin-bottom:0"></h4>&nbsp;<div style="text-align:center">作者：<span class="modal-title-author"></span>&nbsp;&nbsp;&nbsp;提交于：<span class="modal-title-postdate"></span>&nbsp;&nbsp;&nbsp;状态：<span class="modal-title-status mystatus_fail"></span></div>
                        </div>
        ...
        <script src="{$Think.const.USER_JS_URL}list-denied.js"></script>
